            ...
            for (String name : filenames) {
                ...
                // 如果是文件则对文件进行相关操作
                    ...
                    if (matcher.matches()) {
                        ...
                        if (FileUtils.isMusic(fileExtension)) {
                            // 初始化音乐文件......................
                            Log.i("fzw","This file is Music File,fileName="+fileName+"."
                                    +fileExtension+",filePath="+filePath);
                        }

                        if (FileUtils.isPhoto(fileExtension)) {
                            // 初始化图片文件......................
                           Log.i("fzw","This file is Photo File,fileName="+fileName+"."
                                   +fileExtension+",filePath="+filePath);
                        }

                        if (FileUtils.isVideo(fileExtension)) {
                            // 初始化视频文件......................
                            Log.i("fzw","This file is Video File,fileName="+fileName+"."
                                    +fileExtension+",filePath="+filePath);
                        }
                    }
                }
